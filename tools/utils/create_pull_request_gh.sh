...
git clone --branch "${branch_name}" --depth 1 "${repository_name}" "${temporary_folder_path}"
...
# gh pr create --source-branch "${temporary_branch_name}" --target-branch "${branch_name}" --title "${pull_request_title}" --squash --delete-source-branch "true" --repository "${repository_name}"
gh pr create --head "${temporary_branch_name}" --base "${branch_name}" --title "${pull_request_title}" --body "${pull_request_title}"
